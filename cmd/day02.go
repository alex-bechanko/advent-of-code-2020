...
import (
	...
	"github.com/alex-bechanko/advent-of-code-2020/pkg/day02"
	"github.com/spf13/cobra"
)

func init() {

	var defaultInput = fmt.Sprintf("inputs/day02.txt")
	...
	day02Cmd.Flags().StringVarP(&fileInput, "input", "i", defaultInput, "Path to the input data")
