...
import (
	...
	"github.com/alex-bechanko/advent-of-code-2020/pkg/day01"
	"github.com/spf13/cobra"
)

func init() {

	var defaultInput = fmt.Sprintf("inputs/day01.txt")
	var fileInput string

	var day01Cmd = &cobra.Command{
		Use:   "day01",
		Short: "Compute day 1 solutions",
		Long:  "Computes part1 and part2 solutions for day 1 of Advent of Code 2020",
		Run: func(cmd *cobra.Command, args []string) {
			data, err := day01.ParseFile(fileInput)
			if err != nil {
				fmt.Fprintf(os.Stderr, "Error parsing data file: %v\n", err)
				os.Exit(1)
			}

			soln1, err := day01.Solution1(data)
			if err != nil {
				fmt.Fprintf(os.Stderr, "Error computing solution 1: %v", err)
			}

			soln2, err := day01.Solution2(data)
			if err != nil {
	...
	day01Cmd.Flags().StringVarP(&fileInput, "input", "i", defaultInput, "Path to the input data")
