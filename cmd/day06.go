...
import (
	...
	"github.com/alex-bechanko/advent-of-code-2020/pkg/day06"
	"github.com/spf13/cobra"
)

func init() {

	var defaultInput = fmt.Sprintf("inputs/day06.txt")
	...
	var day06Cmd = &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			...
			soln1, err := day06.Solution1(data)
			if err != nil {
				fmt.Fprintf(os.Stderr, "Error computing solution 1: %v", err)
			}

			soln2, err := day06.Solution2(data)
			if err != nil {
	...
	day06Cmd.Flags().StringVarP(&fileInput, "input", "i", defaultInput, "Path to the input data")
